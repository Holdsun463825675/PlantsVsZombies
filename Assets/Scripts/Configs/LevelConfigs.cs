    ...
    private static void InitializeDefaultLevels()
    {
        ...
        levelConfigs.Add(new LevelConfig
        {
            ...
            zombieWaves = new List<ZombieWave> {
                ...
                new ZombieWave {zombieIDs = new List<ZombieID> {ZombieID.FootballZombie, ZombieID.NormalZombie },spawnWeight = 17,largeWave = false,certainlySpawn=1},
                new ZombieWave {zombieIDs = new List<ZombieID> {ZombieID.NormalZombie, ZombieID.FootballZombie },spawnWeight = 17,largeWave = false},
                new ZombieWave {zombieIDs = new List<ZombieID> {ZombieID.FootballZombie, ZombieID.NormalZombie },spawnWeight = 18,largeWave = false,certainlySpawn=1},
                new ZombieWave {zombieIDs = new List<ZombieID> {ZombieID.NormalZombie, ZombieID.FootballZombie },spawnWeight = 19,largeWave = false},
                new ZombieWave {zombieIDs = new List<ZombieID> {ZombieID.FootballZombie, ZombieID.NormalZombie },spawnWeight = 37,largeWave = true,certainlySpawn=1},
            },
            spawnTimer = 25.0f,
            gameSpeed = 2.0f,
        });
        ...
        levelConfigs.Add(new LevelConfig
        {
            ...
            startingSun = 0,
            cardType = TypeOfCard.Conveyor,
            fixedCards = new List<PlantID> { PlantID.PeaShooter, PlantID.CherryBomb, PlantID.WallNut, PlantID.SnowPea, PlantID.Repeater, PlantID.TallNut, PlantID.Pumpkin, PlantID.GtalingPea },
