...
public class ResourceConfig
{
    ...
    public const string sound_bomb_doomshroom = "Audio/Sound/bomb/doomshroom";
    ...
    public const string sound_placeplant_plantWater = "Audio/Sound/placeplant/plant_water";
    ...
    public const string sound_plant_puff = "Audio/Sound/plant/puff";
