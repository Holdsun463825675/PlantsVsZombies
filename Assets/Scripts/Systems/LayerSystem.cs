...
public class LayerSystem : MonoBehaviour
{
    ...
    static void SetupCollisionMatrix()
    {
        ...
        Physics2D.IgnoreLayerCollision(Bowling_layer, Plant_layer, true); // ±£ÁäÇò²»ÓëÖ²ÎïÅö×²
        Physics2D.IgnoreLayerCollision(Bowling_layer, Zombie_layer, true); // ±£ÁäÇò²»Óë½©Ê¬Åö×²
